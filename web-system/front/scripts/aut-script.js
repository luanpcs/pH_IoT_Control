...
function configurarFaixa() {
    ...
    function validate() {
        setTimeout(function () {
            $(".btnConfigFaixa").removeClass("onclic");
            $(".btnConfigFaixa").addClass("validate", 450, callback);
        }, 2250);
    }

    function callback() {
        setTimeout(function () {
            $(".btnConfigFaixa").removeClass("validate");
        }, 1250);
    }
    ...
    if (flagAnimation == 0) {
        $(".btnConfigFaixa").addClass("onclic", 250, validate);
    ...
    $(".btnConfigFaixa").on('click', function () {
        $(this).addClass("onclic", 250, validate);
    });

    const payload = { msgType: 'modo', modo: "a", value: [parseFloat(min), parseFloat(max)] };
